...
class TronApi extends AbstractApi {
    ...
    public function createTronTrc10Blockchain($create_tron_trc10_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $create_tron_trc10_blockchain
            ), 
    ...
    public function createTronTrc10BlockchainKMS($create_tron_trc10_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $create_tron_trc10_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function createTronTrc20Blockchain($create_tron_trc20_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $create_tron_trc20_blockchain
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function createTronTrc20BlockchainKMS($create_tron_trc20_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $create_tron_trc20_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function freezeTron($freeze_tron) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $freeze_tron
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function freezeTronKMS($freeze_tron_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $freeze_tron_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronBlockchain($transfer_tron_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_blockchain
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronBlockchainKMS($transfer_tron_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronTrc10Blockchain($transfer_tron_trc10_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_trc10_blockchain
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronTrc10BlockchainKMS($transfer_tron_trc10_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_trc10_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronTrc20Blockchain($transfer_tron_trc20_blockchain) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_trc20_blockchain
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function transferTronTrc20BlockchainKMS($transfer_tron_trc20_blockchain_kms) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $transfer_tron_trc20_blockchain_kms
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function tronBroadcast($tron_broadcast) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "POST", $rPath, $rPath, [], $rHeaders, [], $tron_broadcast
            ), 
            "\Tatum\Model\TransactionHash"
        );
    ...
    public function tronTrc10Detail($id_or_owner_address) {
        ...
        $result = $this->exec(
            S::createRequest(
                $this->_caller->config(), self::PKG, "GET", S::parse($rPath, ["idOrOwnerAddress" => $id_or_owner_address]), $rPath, [], $rHeaders, []
            ), 
